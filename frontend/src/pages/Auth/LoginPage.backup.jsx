...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <header className="relative z-10 flex flex-col items-center justify-center gap-2 p-4 border-b sm:flex-row sm:gap-3 sm:p-6 border-slate-200/30 bg-white/10 backdrop-blur-sm">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="relative">
            <img src="/Logo.svg" alt="Логотип" className="object-cover w-8 h-8 sm:w-10 sm:h-10" />
        ...
        <div className="relative w-full max-w-md p-6 overflow-hidden border-2 shadow-xl bg-white/90 backdrop-blur-sm sm:p-8 lg:p-10 rounded-2xl lg:rounded-3xl border-slate-200/50 animate-scale-in group">
          ...
          <div className="relative z-10">
            <div className="mb-6 text-center sm:mb-8">
              ...
              <p className="text-xs sm:text-sm text-slate-600">Введите логин и пароль</p>
            </div>
            ...
            <p className="mt-2 text-xs text-center text-slate-400">
              <Link to="/org/login" className="transition-colors hover:text-primary">
